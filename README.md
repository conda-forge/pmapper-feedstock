...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pmapper-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12065&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pmapper-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pmapper` can be installed with:

```
conda install pmapper
```

It is possible to list all of the versions of `pmapper` available on your platform with:
